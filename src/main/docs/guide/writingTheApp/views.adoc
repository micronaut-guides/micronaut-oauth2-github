...
To use https://www.thymeleaf.org/[Thymeleaf] Java template engine within a Micronaut Application  add the following dependency on your classpath. For example, in `build.gradle`
